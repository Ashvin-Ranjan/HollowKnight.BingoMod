...
// Taken from DebugMod, I really cannot code this good tbh
namespace BingoMod.Canvas
{
    public class CanvasButton
    {
        ...
        {
            buttonObj.GetComponent<CanvasRenderer>().SetAlpha(opacity);
            Color n = textObj.GetComponent<Text>().color;
            n.a = opacity;
            textObj.GetComponent<Text>().color = n;
        }
    }
}
